...
<div>
    <?php echo \Form::open(); ?>
    	<div id="legend">
            <legend class=""><?php echo \Lang::get('nvblog.private.pages.edit.title'); ?></legend>
        </div>
        ...
        <fieldset class="left">
    		...
    		<div class="control-group">
    			...
    			<div class="controls"><?php echo \Form::input('title', \Input::post('title', isset($page_values['page']->title) ? $page_values['page']->title : '' ), array('class' => 'medium :required')); ?></div>
    		</div>
