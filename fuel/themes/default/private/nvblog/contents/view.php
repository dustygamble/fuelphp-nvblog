...
<div>
	<div id="legend">
		<legend class=""><?php echo \Lang::get('nvblog.private.contents.view.title'); ?></legend>
	</div>
	...
	<fieldset class="left">
		...
		<div class="control-group buttons">
			<div class="controls">
                <a href="<?php echo \Uri::create('blog/' . $date[3] . '/' . $date[1] . '/' . $page_values['content']->slug); ?>" title="<?php echo \Lang::get('nvblog.shared.view'); ?>"><button class="btn btn-success" type="button"><?php echo \Lang::get('nvblog.shared.view'); ?></button></a>
