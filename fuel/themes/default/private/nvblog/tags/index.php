...
<div>
	<div id="legend">
		<legend class=""><?php echo \Lang::get('nvblog.private.tags.index.title'); ?></legend>
	</div>
	...
	<table class="table">
		<thead>
				<tr>
					<td class="fixed-list"><?php echo \Lang::get('nvblog.shared.status'); ?></td>
					<td class="fixed-list"><?php echo \Lang::get('nvblog.private.shared.action'); ?></td>
...
<div class="btn-toolbar">
	<a href="<?php echo \Uri::create('admin/blog/tags/create'); ?>"><button class="btn btn-primary"><?php echo \Lang::get('nvblog.shared.add'); ?></button></a>
</div>
