...
<div>
	<div id="legend">
		<legend class=""><?php echo \Lang::get('nvblog.private.images.index.title'); ?></legend>
	</div>
	...
	<table class="table">
		<thead>
				<tr>
					<td class="fixed-width90"><?php echo \Lang::get('nvblog.private.images.shared.name_singular'); ?></td>
